    ...
    <template v-if="isAdmin">
      <button
        ...
        :class="[
          hasUpdate
            ...
            : 'bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-dark-900 dark:text-dark-400 dark:hover:bg-dark-900'
        ]"
      ...
      <transition name="dropdown">
        <div
          v-if="dropdownOpen"
          ref="dropdownRef"
          class="absolute left-0 z-50 mt-2 w-64 overflow-hidden rounded-md border border-gray-200 bg-white shadow-md dark:border-dark-800 dark:bg-dark-900"
        >
          ...
          >
            ...
            <button
              ...
              class="rounded-lg p-1.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-dark-900 dark:hover:text-dark-200"
              :disabled="loading"
          ...
          <div class="p-4">
            ...
            <template v-else>
              ...
              <div v-else-if="hasUpdate && !isReleaseBuild" class="space-y-2">
                ...
                <!-- Source build hint -->
                <div
                  class="flex items-center gap-2 rounded-lg border border-primary-200 bg-primary-50 p-2 dark:border-primary-900/60 dark:bg-primary-950/30"
                >
                  <svg
