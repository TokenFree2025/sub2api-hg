...
> = {
  alipay: [
    { value: "", labelZh: "未配置", labelEn: "Not configured", labelKo: "구성되지 않음" },
    {
  ...
  wxpay: [
    { value: "", labelZh: "未配置", labelEn: "Not configured", labelKo: "구성되지 않음" },
    {
      ...
      labelKo: "공식 WeChat Pay",
    },
    {
      value: "easypay_wxpay",
      labelZh: "易支付微信",
      labelEn: "EasyPay WeChat Pay",
      labelKo: "EasyPay WeChat Pay",
    },
  ],
};
...
const WECHAT_CONNECT_MODE_OPTIONS: WeChatConnectModeOption[] = [
  { value: "open", labelZh: "PC 应用", labelEn: "PC App", labelKo: "PC 앱" },
  {
    value: "mp",
    labelZh: "公众号",
