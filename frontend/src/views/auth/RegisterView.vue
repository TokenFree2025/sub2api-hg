...
const LOGIN_AGREEMENT_STORAGE_KEY = 'tokendeal_login_agreement_consent'
...
const siteName = ref<string>('tokendeal')
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || 'tokendeal'
...
function rejectLoginAgreement(): void {
  ...
  showAgreementModal.value = false
  appStore.showWarning(t('auth.agreement.registerInputDisabled'))
}
...
function validateForm(): boolean {
  ...
  if (agreementGateActive.value) {
    appStore.showWarning(t('auth.agreement.acceptBeforeRegister'))
